...
\documentclass[
  ...
  printcommittee=true,  % set to 'false' from submitted versins who should not have 
    ...
    maxbibnames=99,			% Never use 'et al' in the bibliography
		...
		url=false,          % disable printing URLs in bibliography
...
\title{Usability Evaluation of Domain-Specific Languages}
%\subtitle{Science is beautiful}

% Autor
% use [f] for female and [m] for male
\authorname[f]{Ankica Bari\v{s}i\'{c}}{Ankica Bari\v{s}i\'{c}}
...
% use [f] for female and [m] for male
\adviser[m]{Vasco Amaral}{Assistant Professor}{\\&Faculdade de Ciências e Tecnologia\\& da Universidade Nova de Lisboa} 
...
% use [f] for female and [m] for male
\coadviser[m]{Miguel Goul\~ao}{Assistant Professor}{\\&Faculdade de Ciências e Tecnologia\\& da Universidade Nova de Lisboa}
